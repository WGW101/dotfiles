...
if [ "$color_prompt" = yes ]; then
	...
	PS1=$PS1'[\[\033[32m\]\D{%m-%d} \A\[\033[00m\]]'
	PS1=$PS1' \[\033[01;34m\]\u\[\033[00m\]'
	PS1=$PS1'@\[\033[01;31m\]\h\[\033[00m\]'
	PS1=$PS1':\[\033[33m\]\w\[\033[00m\]'
	PS1=$PS1' $([ \j -gt 0 ] && echo "[\[\033[01;35m\]\j\[\033[00m\]]")'
	PS1=$PS1'\$ '
else
	PS1='${debian_chroot:+($debian_chroot)}[\D{%F} \A] \u@\h:\w $([ \j -gt 0 ] && echo [\j])\$ '
fi
